    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="list" action="index"><g:message code="Справочник стран" args="[entityName]" /></g:link></li>
        ...
        <div id="edit-country" class="content scaffold-edit" role="main">
            <h1><g:message code="Редактировать информацию о стране" args="[entityName]" /></h1>
            ...
            <g:form resource="${this.country}" method="PUT">
                ...
                <fieldset class="buttons">
                    <input class="save" type="submit" value="${message(code: 'Редактировать', default: 'Редактировать')}" />
                </fieldset>
            </g:form>
        </div>
    </body>
